...
Documentation for the Wallpanel App is here https://wallpanel.xyz/docs/getting-started and you need to set it up to use MQTT and to be discoverable. Don't forget that you need to set up a unique mqtt user name and password for Wallpanel. I used "clock-user" and clock-pass". When HA has found it you will see a new device with properites that will be useful later.
